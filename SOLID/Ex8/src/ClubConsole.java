public class ClubConsole {
    ...
    public void run() {
        FinanceAdminTools treasurer = new TreasurerTool(ledger);
        MinutesAdminTools secretary = new SecretaryTool(minutes);
        EventsAdminTools lead = new EventLeadTool(events);
